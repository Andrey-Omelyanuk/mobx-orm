    ...
    ***************************************************************************** */
    ...
    class Query {
        ...
        constructor(props) {
            ...
            mobx.makeObservable(this);
            this.__disposers.push(mobx.reaction(() => { var _a, _b; return (_b = (_a = this.repository) === null || _a === void 0 ? void 0 : _a.adapter) === null || _b === void 0 ? void 0 : _b.getURLSearchParams(this).toString(); }, mobx.action('MO: Query Base - need to update', () => {
